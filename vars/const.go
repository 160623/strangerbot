...
If you require any help, feel free to contact @aaldentnay !`
	...
	RateLimitMessage         = `You have hit your weekly limit! Wait a few days before trying again. Make a donation at https://Patreon.com/SupportTheBot (you’ll be  able to increase the number of times you can press /start or opt to get faster matches! This helps cover server/development costs.)`
